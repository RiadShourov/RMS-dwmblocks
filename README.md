# dwmblocks
This repo is edited from Luke Smith's dwmblocks.
...
Luke has dwmblocks read my preexisting scripts
[here in my dotfiles repo](https://github.com/LukeSmithxyz/voidrice/tree/master/.local/bin/statusbar).
So if you want his build out of the box, download those and put them in your
`$PATH`. It is done to avoid redundancy in LARBS, both i3 and dwm use the same
statusbar scripts.
